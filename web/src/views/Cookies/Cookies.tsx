...
const Cookie: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg mt-10">
      ...
      <h1 className="text-3xl text-center font-bold mb-4 text-gray-800">Política de Cookies</h1>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 text-gray-700">¿Qué son las cookies?</h2>
      <p className="text-gray-800 mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 text-gray-700">¿Qué tipos de cookies utilizamos?</h2>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 text-gray-700">¿Cómo puede gestionar las cookies?</h2>
      <p className="text-gray-800 mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 text-gray-700">Más información</h2>
