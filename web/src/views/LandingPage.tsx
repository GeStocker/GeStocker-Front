...
const LandingPage = () => {
  return (
    <div>
      <section className="flex flex-col-reverse md:flex-row gap-4 w-full items-center justify-center my-2 md:my-12 px-2 md:px-16">
        <div className="flex flex-col gap-4">
          <h1 className="text-2xl md:text-5xl font-bold text-gray-950 text-center md:text-left">
            Gestiona tu inventario de forma simple y eficiente
          </h1>
          <p className="text-base md:text-xl text-textSubtitle text-center md:text-left">
      ...
      <section className="w-full bg-miGris flex items-center flex-col justify-center my-2 md:my-8 p-4 gap-1">
        ...
        <p className="text-base md:text-xl text-textSubtitle max-w-[30rem] text-center">
          Gestionar tu inventario nunca ha sido tan fácil
        </p>
        <div className="flex flex-col md:flex-row gap-4 my-2 md:gap-16 md:my-8 wrap">
          <StepCard
      ...
      <section className="w-full bg-white flex items-center flex-col justify-center my-2 md:my-8 p-4 gap-1">
        <h2
          className="font-bold text-gray-950 text-xl md:text-4xl text-center"
        >
        ...
        <div className="flex flex-col md:flex-row gap-4 my-2 md:gap-5 md:my-8 flex-wrap items-center justify-center">
          <BenefitCard
      ...
      <section className="w-full bg-miGris flex items-center flex-col justify-center my-2 md:my-8 p-4 gap-1">
        ...
        <div className="flex flex-col md:flex-row flex-wrap gap-4 md:gap-16 my-2 md:my-8">
          <SuscriptionCard
            title="Básico"
            price="19"
            items={["Prueba gratuita por 7 días", "Hasta 500 productos", "2 usuarios", "2 Soporte por email"]}
          />
          <SuscriptionCard
            title="Profesional"
            price="49"
      ...
      <section className="flex flex-col-reverse md:flex-row gap-4 w-full items-center justify-center my-2 md:my-12 px-2 md:px-16">
        ...
        <img src="hero2.webp" alt="Hero imagen" className="w-full md:w-1/2 rounded-md" />
      </section>
    </div>
  );
};
