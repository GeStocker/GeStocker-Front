...
const PrivacyPolicyView = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 text-custom-textSubtitle">
      ...
      <h2 className="text-2xl font-semibold text-custom-casiNegro mt-6 mb-2">1. Información Recopilada</h2>
      ...
      <h2 className="text-2xl font-semibold text-custom-casiNegro mt-6 mb-2">2. Uso de la Información</h2>
      ...
      <h2 className="text-2xl font-semibold text-custom-casiNegro mt-6 mb-2">3. Protección de Datos</h2>
      ...
      <h2 className="text-2xl font-semibold text-custom-casiNegro mt-6 mb-2">4. Cookies</h2>
      ...
      <h2 className="text-2xl font-semibold text-custom-casiNegro mt-6 mb-2">5. Contacto</h2>
      <p className="mb-4">Si tiene preguntas sobre esta política, puede contactarnos en <strong>soporte@gestocker.com</strong>.</p>
      
      <p className="text-sm text-custom-textGris text-center mt-6">Última actualización: {new Date().getFullYear()}</p>
    </div>
  );
};
