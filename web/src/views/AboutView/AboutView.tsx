...
const AboutView = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 text-gray-800">
      ...
      <h1 className="text-3xl font-bold text-center text-gray-950 mb-6">Acerca de GeStocker</h1>
      ...
      <h2 className="text-2xl font-semibold text-gray-950 mt-6">¿Por qué elegir GeStocker?</h2>
