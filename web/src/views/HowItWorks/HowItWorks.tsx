    ...
    <div>
      <section className="flex flex-row gap-4 w-full items-center justify-center py-8 bg-custom-grisClarito ">
        <div className="flex flex-col gap-4">
          <h1 className="text-5xl font-bold text-gray-950 text-center">
        ...
        <div className="flex px-6">
          <div className="grid grid-cols-2 gap-12 items-center">
            <div className="flex flex-col justify-center gap-4">
              <div className="flex items-center rounded-full bg-custom-GrisOscuro px-3 py-1 text-sm font-medium text-black w-fit">
                <span>Paso 1</span>
              </div>
              <h2 className="text-3xl font-bold">Regístrate</h2>
              <p className="text-custom-textGris">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  <CheckCircle2 className="mr-2 h-5 w-5 text-gray-950 flex mt-0.5" />
                  <span>
            ...
            <div className="flex items-center justify-center overflow-hidden rounded-lg border bg-black shadow-lg w-[600px] aspect-video">
